...
class __$$NoConnectionImplCopyWithImpl<$Res>
    extends _$ProductStateCopyWithImpl<$Res, _$NoConnectionImpl>
...
class _$NoConnectionImpl implements _NoConnection {
  ...
  @override
  String toString() {
    return 'ProductState.noConnection()';
  }
...
abstract class _NoConnection implements ProductState {
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<ProductModel> data) : _data = data;
...
abstract class _Success implements ProductState {
  const factory _Success(final List<ProductModel> data) = _$SuccessImpl;
